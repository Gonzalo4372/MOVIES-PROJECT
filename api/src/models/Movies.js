...
const Movie = (sequelize) => {
  sequelize.define(
    ...
    {
      id: {
        type: DataTypes.UUID,   // Generar un único ID
        allowNull: false,       // Es obligatorio el name
        primaryKey: true,       
    ...
    {
      timestamps: false,  // Esto es para que no me marque la fecha y horario en la fue creada la tabla en la base de datos
    }
  );
};
